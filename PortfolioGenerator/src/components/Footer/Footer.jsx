...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-200">
      <Container>
        <div className="py-12">
          {/* Improved grid layout for better responsive behavior */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            {/* Newsletter signup with improved responsive design */}
            <div>
              <h3 className="text-sm font-semibold text-gray-500 tracking-wider uppercase mb-4">
              ...
              <form className="flex flex-col sm:flex-row gap-2 max-w-full">
                <input
                  ...
                  className="px-4 py-2 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full"
                />
                <button
                  onClick={onSubscribe}
                  type="submit"
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
              <div className="mb-4 sm:mb-0">
                ...
                <p className="text-gray-500 mt-2">
                  © {currentYear} Portfolio Generator. All rights reserved.
                </p>
              </div>
