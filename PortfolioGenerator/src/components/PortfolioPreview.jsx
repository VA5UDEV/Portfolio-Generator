      ...
      {TemplateComponent ? (
        ...
        <div className="p-6 border rounded-lg shadow-md bg-white text-center">
          ...
          <p className="text-gray-800 mt-4">
            <strong>Skills:</strong> {formattedUserData.skills.join(", ")}
          </p>
          ...
          <p className="text-gray-800">
            <strong>Education:</strong> {formattedUserData.education.join(", ")}
          </p>
          <div className="mt-4 text-blue-600">
            <p>
              <strong>Email:</strong> {formattedUserData.contact.email}
            </p>
            <p>
              <strong>Phone:</strong> {formattedUserData.contact.phone}
            </p>
            <p>
              <strong>Address:</strong> {formattedUserData.contact.address}
            </p>
          </div>
        </div>
      )}
